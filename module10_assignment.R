...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      selectInput(inputID = "subset_income",label = "subset_income", value = c("<=50K","50K")),
      # Interactive piece 2: inputId = "set_yaxis"
      selectInput(inputID = "set_yaxis",label = "set_yaxis", value = c("hours_per_week","capital_loss")),
      # Interactive piece 3: inputId = "subset_occupation"
      selectInput(inputID ="subset_occupation",label = "Include operations:",
